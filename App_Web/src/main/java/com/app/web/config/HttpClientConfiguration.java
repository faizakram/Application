...
public class HttpClientConfiguration {
    ...
    public PoolingHttpClientConnectionManager getPoolingConnectionManager() {
        ...
        poolingConnectionManager.setMaxTotal(CommonConstants.MAX_TOTAL_CONNECTIONS);
            ...
            public void run() {
                try {
                    if (connectionManager != null) {
                        ...
                        connectionManager.closeIdleConnections(CommonConstants.CLOSE_IDLE_CONNECTION_WAIT_TIME_SECS, TimeUnit.SECONDS);
                    } else {
            ...
            public long getKeepAliveDuration(HttpResponse response, HttpContext context) {
                ...
                while (it.hasNext()) {
                    ...
                    if (value != null && param.equalsIgnoreCase("timeout")) {
                        return Long.parseLong(value) * CommonConstants.ONE_SECOND_IN_MILLIS;
                    }
                }
                return CommonConstants.DEFAULT_KEEP_ALIVE_TIME_MILLIS;
            }
        };
    }
    ...
    public CloseableHttpClient getHttpClient() {
        RequestConfig requestConfig = RequestConfig.custom()
                .setConnectionRequestTimeout(CommonConstants.REQUEST_TIMEOUT)
                .setConnectTimeout(CommonConstants.CONNECT_TIMEOUT)
                .setSocketTimeout(CommonConstants.SOCKET_TIMEOUT).build();
